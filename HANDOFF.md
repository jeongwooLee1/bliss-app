...
## 📌 현재 라이브: v3.7.949 (https://blissme.ai/version.txt) — 2026-06-01

### ✅ 이번 세션 완료 (2026-06-01) — v3.7.939~949 (상세 CLAUDE.md 변경이력)
- **v3.7.949** 구독권 **표시 보강** — 매출입력 화면에 "구독권 보유 · {무료시술} 무제한 무료 (유효~날짜)" 카드(직원 인지) + 예약모달 보유권 pill "99회"→**"무제한"**. 박현지님 라이브 무료 미적용은 구버전 캐시 원인(새로고침으로 해결 확인).
