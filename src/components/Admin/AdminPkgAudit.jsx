    ...
    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:6}}>
      ...
      {blissEdit ? <div style={{marginBottom:6}}>
        ...
        {(() => {
          ...
          const PKG_OPTIONS = ["토탈PKG 5회","왁싱PKG 5회","힐링PKG 5회","케어PKG 8회","비키니PKG 5회","항문PKG 5회","재생PKG 5회","재생힐링PKG 5회","간단PKG 5회","깨끗이PKG 5회","소급PKG 1회권","커플프리패스 3회","다담권","연간할인권","60에너지 10회권","60에너지 5회권","60에너지 1회권","20에너지 5회권","20에너지 1회권","10%추가적립쿠폰","제품전용8만원쿠폰","제품전용3만원쿠폰","기기스크럽1회"];
        ...
        <div style={{display:"flex",gap:4,alignItems:"center",padding:"4px 0",borderTop:"1px dashed "+T.primary,marginTop:3,fontSize:12}}>
          ...
          <select value={newItem.svc_name} onChange={e=>setNewItem(p=>({...p,svc_name:e.target.value}))} style={{...eipt,flex:1,textAlign:"left"}}>
            ...
            {["토탈PKG 5회","왁싱PKG 5회","힐링PKG 5회","케어PKG 8회","비키니PKG 5회","항문PKG 5회","재생PKG 5회","재생힐링PKG 5회","간단PKG 5회","깨끗이PKG 5회","소급PKG 1회권","커플프리패스 3회","다담권","연간할인권","60에너지 10회권","60에너지 5회권","60에너지 1회권","20에너지 5회권","20에너지 1회권","10%추가적립쿠폰","제품전용8만원쿠폰","제품전용3만원쿠폰","기기스크럽1회"].map(n=><option key={n} value={n}>{n}</option>)}
          </select>
          {isNewDadam
