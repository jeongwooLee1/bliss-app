...
function AdminNoti({ data, setData, sb, bizId, branches }) {
  ...
  const GROUPS=[
    ...
    {label:"시술후 케어 알림 (SMS 발송)", sms:true, items:[
      {key:"after_1d_first_only",label:"시술 후 1일 (신규·1회)",desc:"신규 고객 + 패키지/금액권 미구매 + 1회만 방문한 고객 대상", hasTime:true, sms:true},
      ...
      {key:"after_60d",label:"시술 후 60일",desc:"시술 60일 후 재방문 안내", hasTime:true, sms:true},
    ]},
    {label:"포인트 알림",items:[
