...
<div style={{marginLeft:"auto",position:"relative",flexShrink:0}} ref={el => { if(el) el._settingsBtn = el; }}>
        ...
        <div className="tl-grid-card" style={{display:"flex",minWidth:"fit-content",position:"relative"}} onClick={handleTlClick}>
          ...
          <div className="tl-time-col" style={{width:timeLabelsW,flexShrink:0,position:"sticky",left:0,zIndex:20,background:T.bgCard,borderRight:"1px solid #eee"}}>
            ...
            <div style={{height:headerH,borderBottom:"1px solid #eee",position:"sticky",top:topbarH,zIndex:25,background:T.bgCard,boxShadow:"0 -1px 6px -2px rgba(0,0,0,.08), 0 4px 8px -2px rgba(0,0,0,0.12), -8px 0 12px -5px rgba(0,0,0,.10)"}}/>
          ...
          {allRooms.map((room, ci) => {
            ...
            const _edgeShadows = isLastOfBranch ? "8px 0 14px -6px rgba(0,0,0,.14)" : "none";
            return (
              <div key={room.id} className="tl-room-col" data-branch-id={room.branch_id} style={{
                ...
                <div style={{height:headerH,borderBottom:"1px solid #eee",position:"sticky",top:topbarH,zIndex:10,background:colBg,
                  ...
                  // 좌측 그림자는 제거 — 갭에서 양쪽 겹치면 과함 (v3.8.49)
                  boxShadow:"0 -1px 6px -2px rgba(0,0,0,.08), 0 4px 8px -2px rgba(0,0,0,0.12)"
                    + (isLastOfBranch ? ", 8px 0 12px -5px rgba(0,0,0,.13)" : ""),
