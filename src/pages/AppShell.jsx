...
function MobileBottomNav({ nav, page, setPage, isChatOpen=false }) {
  ...
  return (
    <>
      ...
      <nav className="mob-bottom-nav" style={{position:"fixed",bottom:0,left:0,right:0,background:T.bgCard,borderTop:`1px solid ${T.border}`,zIndex:100,display:"flex",alignItems:"flex-start",paddingTop:4,paddingBottom:2}}>
        {items.map(item=>{
